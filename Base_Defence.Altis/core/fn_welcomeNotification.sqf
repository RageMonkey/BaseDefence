...
[
	...
	"Feel free to join the community at www.rotgaming.net and our teamspeak on ts.rotgaming.net",
	"If the attackers make it into the middle of the base you will automatically lose!",
	"Server rules and controls can be found in the map.",
	"The server is based heavily from Altis Life so a huge thanks to Tonic for creating the frame work for us to use. We hope you enjoy your stay on the server and have a great time playing."
];
