...
//House Limit
__CONST__(life_houseLimit,0); //Maximum amount of houses a player can buy (TODO: Make Tiered licenses).

//Gang related stuff?
__CONST__(life_gangPrice,99999999); //Price for creating a gang (They're all persistent so keep it high to avoid 345345345 gangs).
...
switch (playerSide) do
{
	...
	case civilian: 
	{
		life_atmcash = 250; //Starting Bank Money
